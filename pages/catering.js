    ...
    <>
      ...
      <main>
        ...
        <section className="section contentSection" id="about">
          <div className="textBlock narrow">
            ...
            <p>
              Established in 2020, SoulFood Fusion Catering & Events is dedicated
              to delivering exceptional dining experiences through a unique
              fusion of Filipino cuisine and international flavors.
            </p>
            <p>
              The business is owned by Chef Antonio Patricio Lim, whose culinary
              expertise was developed through years of experience working in
              international cuisine on luxury cruise ships and in Middle Eastern
              countries. Together with his wife, Yzabel Vale, they have built
              SoulFood into a trusted name in catering — known for quality,
              consistency, and refined presentation.
            </p>
            <p>
              Combining global culinary standards with Filipino hospitality,
              SoulFood Fusion Catering & Events offers thoughtfully prepared
              dishes made from fresh ingredients and crafted to impress every
              guest.
            </p>
            <p>
              From weddings and private celebrations to corporate events, the
              team is committed to providing generous servings, flexible
              catering options, and a seamless, stress-free experience.
            </p>
          </div>
        </section>
      ...
      <footer className="footer">
        <div className="footerInner">
          <h3 className="footerTitle">Soulfood Fusion Catering</h3>
          <p>8 High St, Bendigo VIC 3550</p>
          <p>soulfoodfusionhouse@gmail.com</p>
          <p>(+61) 0413 326 097</p>
