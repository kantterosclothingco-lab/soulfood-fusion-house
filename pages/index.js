      ...
      {showPopup && (
        <div className="popupOverlay">
          <div className="popupContainer">
            ...
            <img
              src="/images/JexDeCastroPoster.jpg"
              alt="Jex De Castro Live Show"
              className="eventPoster"
            />

            <a href="tel:+61413326097">
              <button className="eventBtn">BOOK YOUR TICKETS NOW</button>
            </a>
          </div>
        </div>
      )}
      ...
      <style jsx global>{`
        * {
        ...
        .popupContainer {
          width: 430px;
          max-width: 92vw;
          background: linear-gradient(135deg, #120b06, #2b1a0c);
          border: 1px solid rgba(218, 176, 95, 0.7);
          border-radius: 24px;
          padding: 16px;
          position: relative;
        ...
        .eventBtn {
          ...
          border: none;
          border-radius: 999px;
          background: linear-gradient(135deg, #b8893e, #f4d28a);
          color: #17100a;
          font-weight: 900;
          cursor: pointer;
        }
