...
const menuSections = [
  {
    ...
    items: [
      {
        name: "Filo BBQ Ribs (Single)",
        price: "$29.90",
        image: "/images/menu/filo-bbq-ribs.jpg",
        description:
          "Filo style pork ribs barbecue. Comes with Java rice, chips, or salad.",
      },
      {
        name: "Filo BBQ Ribs (Share)",
        price: "$34.00",
        image: "/images/menu/filo-bbq-ribs.jpg",
        description: "Share serving. Comes with salad only.",
      },
      {
        name: "Grilled Chicken Inasal (Single)",
        price: "$24.90",
        image: "/images/menu/grilled-chicken-inasal.jpg",
        description:
          "Char-grilled chicken marinated in Soulfood special sauce. Comes with rice, chips, or salad.",
      },
      {
        name: "Grilled Chicken Inasal (Share)",
        price: "$28.90",
        image: "/images/menu/grilled-chicken-inasal.jpg",
        description: "Share serving. Comes with salad only.",
      },
      {
        name: "Pinoy Barbeque Skewers (Meal)",
        price: "$24.50",
        image: "/images/menu/pinoy-barbeque-skewers.jpg",
        description:
          "Pinoy's barbeque marinated with Soulfood signature barbeque sauce. Meal with rice or salad.",
      },
      {
        name: "Pinoy Barbeque Skewers (3 Pcs)",
        price: "$21.00",
        image: "/images/menu/pinoy-barbeque-skewers.jpg",
        description: "Family share option, 3 pieces.",
      },
      {
        name: "Pinoy Barbeque Skewers (8 Pcs)",
        price: "$42.00",
        image: "/images/menu/pinoy-barbeque-skewers.jpg",
        description: "Family share option, 8 pieces.",
      },
      {
        ...
        description:
          "300 grams Vic farm grain. Includes salad, veggies, Java rice, mash, or chips.",
      },
      {
      ...
      },
      {
        ...
        description: "A sizzling vegetarian option.",
      },
      {
      ...
      },
      {
        ...
        description: "A hearty crispy pork belly roll.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        description: "Crispy calamari appetizer.",
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: "Whole crispy fried tilapia. Additional sauce $5.00.",
      },
      {
        name: "Sweet & Sour Barramundi (Regular)",
        price: "$36.90",
        image: "/images/menu/sweet-sour-barramundi.jpg",
        description: "Whole barramundi served in a sweet and sour style.",
      },
      {
        name: "Sweet & Sour Barramundi (Large)",
        price: "$39.90",
        image: "/images/menu/sweet-sour-barramundi.jpg",
        description: "Large whole barramundi served in a sweet and sour style.",
      },
      {
